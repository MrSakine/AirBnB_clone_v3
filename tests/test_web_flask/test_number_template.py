...
web_flask = __import__(
    "web_flask.5-number_template", globals(), locals(), ["*"]
)


class TestNumberTemplateDocs(unittest.TestCase):
    ...
    def test_all_function_docs(self):
        ...
        all_functions = TestNumberTemplateDocs.all_funcs
    ...
    def test_file_is_executable(self):
        ...
        file_stat = stat("web_flask/5-number_template.py")
