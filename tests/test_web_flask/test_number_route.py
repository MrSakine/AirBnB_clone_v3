...
web_flask = __import__(
    "web_flask.4-number_route", globals(), locals(), ["*"]
)


class TestNumberRouteDocs(unittest.TestCase):
    ...
    def test_all_function_docs(self):
        ...
        all_functions = TestNumberRouteDocs.all_funcs
    ...
    def test_file_is_executable(self):
        ...
        file_stat = stat("web_flask/4-number_route.py")
