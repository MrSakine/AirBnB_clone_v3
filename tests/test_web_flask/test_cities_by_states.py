...
web_flask = __import__(
    "web_flask.8-cities_by_states", globals(), locals(), ["*"]
)


class TestCitiesStateDocs(unittest.TestCase):
    ...
    def test_all_function_docs(self):
        ...
        all_functions = TestCitiesStateDocs.all_funcs
    ...
    def test_file_is_executable(self):
        ...
        file_stat = stat("web_flask/8-cities_by_states.py")
