...
web_flask = __import__(
    "web_flask.3-python_route", globals(), locals(), ["*"]
)


class TestPythonRouteDocs(unittest.TestCase):
    ...
    def test_all_function_docs(self):
        ...
        all_functions = TestPythonRouteDocs.all_funcs
    ...
    def test_file_is_executable(self):
        ...
        file_stat = stat("web_flask/3-python_route.py")
