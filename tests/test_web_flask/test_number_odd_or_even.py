...
web_flask = __import__(
    "web_flask.6-number_odd_or_even", globals(), locals(), ["*"]
)


class TestNumOddEvenDocs(unittest.TestCase):
    ...
    def test_all_function_docs(self):
        ...
        all_functions = TestNumOddEvenDocs.all_funcs
    ...
    def test_file_is_executable(self):
        ...
        file_stat = stat("web_flask/6-number_odd_or_even.py")
