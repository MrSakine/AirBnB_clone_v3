...
The console contains the initial stage of a student project to build a clone of the AirBnB website. This stage implements a backend interface, or console, to manage program data. Console commands allow the user to create, update, and destroy objects, as well as manage file storage. Using a system of JSON serialization/deserialization, storage is persistent between sessions.
...
#### Alternative Syntax - class names
...
Web static is about deploying our `web_static` files on our servers
...
| 4: Keep it clean! | [100-clean_web_static.py](https://github.com/MrSakine/AirBnB_clone_v2/blob/main/100-clean_web_static.py) | Based on the file `3-deploy_web_static.py`, deletes out-of-date archives |
| 5: Puppet for setup | [101-setup_web_static.pp](https://github.com/MrSakine/AirBnB_clone_v2/blob/main/101-setup_web_static.pp) | Sets up your web servers for the deployment of web_static from Puppet tool |
